...
<p class="lede" style="margin-top:24px;">
unknown を受け取れるのは any と unknown だけ。惜しいところまで来ますが、<br>
unknown を除外できません。
</p>
...
<p class="lede" style="margin-top:24px;">
交差型を丸ごと飲み込むのは any だけ。<br>
any 以外を入れても、結果は 1 か never にしかなりません。
</p>
...
<p class="lede" style="margin-top:24px;">
0 は 1 にも never にも代入できないので、<code>0 extends 1 & T</code> は本来「絶対に false」の式。<br>
...
<p class="lede" style="margin-top:24px;">
「交差を飲み込む」と「何でも受け取る」。<br>
2つの性質を同時に持つ型は any しかありません。
</p>
