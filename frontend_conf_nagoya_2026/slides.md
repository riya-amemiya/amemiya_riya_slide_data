...
<table class="engines">
  ...
  <tbody>
    ...
    <tr><td class="engine">Ladybird</td><td>LibJS</td><td>Ladybird project</td></tr>
  </tbody>
</table>
...
<div class="flow" style="margin-top:28px">
  ...
  <div class="arrow">→</div>
  <div class="step"><div class="n">STAGE 4</div><h3>Finished</h3><p>2つの実装が Test262 を通過して仕様に組み込み。</p></div>
</div>
...
<br>
<span>このサイクルが「どのブラウザでも同じ結果になる」を支えている。</span>
</p>
