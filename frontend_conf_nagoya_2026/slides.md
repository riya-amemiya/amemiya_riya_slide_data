...
Ecma International の中に TC39（Technical Committee 39）という委員会があり、ここが ECMAScript の仕様策定を担当しています。
...
## Chrome、Safari、Firefoxどれで実行しても同じ結果
...
スライド作成時点で 50,000 以上の独立したテストファイルで構成されています。
...
test262.status に FAIL が登録されていたからこそ、どの仕様に違反しているかが明確に分かりました。
